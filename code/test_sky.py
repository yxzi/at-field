...
parser.add_argument("--eps", type=int, default=0.3, help="eps parameter for PGD adversarial trainer")
parser.add_argument("--eps_step", type=int, default=0.1, help="nb_grads parameter for DeepFool adversarial trainer")
...
adv_crafter_targeted = ProjectedGradientDescent(classifier, targeted=True, eps=args.eps_step, eps_step=args.eps_step, max_iter=5)
